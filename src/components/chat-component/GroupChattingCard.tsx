import type { GroupChatting } from "../../stores/useGroupChattingStore";
import { timeAgo } from "../../utils/timeAgo";
import styles from "./DirectChattingCard.module.scss";

interface GroupChattingCardProps {
  data: GroupChatting;
  onClick: (chatroomId: number) => void;
  onLeave: (chatroomId: number) => void;
}

const GroupChattingCard = ({
  data,
  onClick,
  onLeave,
}: GroupChattingCardProps) => {
...
export default GroupChattingCard;
